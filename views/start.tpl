...
<html>
    ...
    <body onload="setUp()">
        ...
        <div id="wrapper">
            ...
            <div class="annonspuff">
                <h3 class="puff_titel">Titel 3</h3>
                <p class="puff_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec leo in purus sollicitudin blandit in ut ipsum. Cras placerat, elit eu iaculis laoreet, metus magna congue urna, eget feugiat sapien justo eget lacus</p>
            </div>
            
            <div class="annonspuff">
                <h3 class="puff_titel">Titel 4</h3>
                <p class="puff_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec leo in purus sollicitudin blandit in ut ipsum. Cras placerat, elit eu iaculis laoreet, metus magna congue urna, eget feugiat sapien justo eget lacus</p>
            </div>
            
            <div class="annonspuff">
                <h3 class="puff_titel">Titel 5</h3>
                <p class="puff_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec leo in purus sollicitudin blandit in ut ipsum. Cras placerat, elit eu iaculis laoreet, metus magna congue urna, eget feugiat sapien justo eget lacus</p>
            </div>
            
            <div class="annonspuff">
                <h3 class="puff_titel">Titel 6</h3>
                <p class="puff_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec leo in purus sollicitudin blandit in ut ipsum. Cras placerat, elit eu iaculis laoreet, metus magna congue urna, eget feugiat sapien justo eget lacus</p>
            </div>
            
            <div class="annonspuff">
                <h3 class="puff_titel">Titel 7</h3>
                <p class="puff_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec leo in purus sollicitudin blandit in ut ipsum. Cras placerat, elit eu iaculis laoreet, metus magna congue urna, eget feugiat sapien justo eget lacus</p>
            </div>
            
            <div class="annonspuff">
                <h3 class="puff_titel">Titel 9</h3>
                <p class="puff_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec leo in purus sollicitudin blandit in ut ipsum. Cras placerat, elit eu iaculis laoreet, metus magna congue urna, eget feugiat sapien justo eget lacus</p>
            </div>
            
            <div class="annonspuff">
                <h3 class="puff_titel">Titel 10</h3>
                <p class="puff_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec leo in purus sollicitudin blandit in ut ipsum. Cras placerat, elit eu iaculis laoreet, metus magna congue urna, eget feugiat sapien justo eget lacus</p>
            </div>
